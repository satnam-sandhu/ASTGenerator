// $ANTLR 3.4 Java.g 2018-01-24 19:01:27
...
public class JavaLexer extends Lexer {
    ...
    public final void mHexLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:748:12: ( '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )? )
            // Java.g:748:14: '0' ( 'x' | 'X' ) ( HexDigit )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            ...
            // Java.g:748:38: ( IntegerTypeSuffix )?
            int alt2=2;
    ...
    public final void mDecimalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:750:16: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )? )
            // Java.g:750:18: ( '0' | '1' .. '9' ( '0' .. '9' )* ) ( IntegerTypeSuffix )?
            {
            // Java.g:750:18: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt4=2;
            ...
            // Java.g:750:45: ( IntegerTypeSuffix )?
            int alt5=2;
    ...
    public final void mOctalLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:752:14: ( '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )? )
            // Java.g:752:16: '0' ( '0' .. '7' )+ ( IntegerTypeSuffix )?
            {
            match('0'); 
            ...
            // Java.g:752:32: ( IntegerTypeSuffix )?
            int alt7=2;
    ...
    public final void mFloatingPointLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:761:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ FloatTypeSuffix )
            int alt18=4;
            alt18 = dfa18.predict(input);
            switch (alt18) {
                case 1 :
                    // Java.g:761:9: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )?
                    {
                    // Java.g:761:9: ( '0' .. '9' )+
                    int cnt8=0;
                    loop8:
                    ...
                    break;
                case 2 :
                    // Java.g:762:9: '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )?
                    {
                    match('.'); 
                    ...
                    break;
                case 3 :
                    // Java.g:763:9: ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )?
                    {
                    // Java.g:763:9: ( '0' .. '9' )+
                    int cnt15=0;
                    loop15:
                    ...
                    break;
                case 4 :
                    // Java.g:764:9: ( '0' .. '9' )+ FloatTypeSuffix
                    {
                    // Java.g:764:9: ( '0' .. '9' )+
                    int cnt17=0;
                    loop17:
    ...
    public final void mExponent() throws RecognitionException {
        try {
            // Java.g:769:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // Java.g:769:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public final void mCharacterLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:774:5: ( '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) ) '\\'' )
            // Java.g:774:9: '\\'' ( EscapeSequence |~ ( '\\'' | '\\\\' ) ) '\\''
            {
            match('\''); 

            // Java.g:774:14: ( EscapeSequence |~ ( '\\'' | '\\\\' ) )
            int alt21=2;
    ...
    public final void mStringLiteral() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:778:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' )
            // Java.g:778:8: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
            {
            match('\"'); 

            // Java.g:778:12: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
            loop22:
            do {
                int alt22=3;
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // Java.g:784:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UnicodeEscape | OctalEscape )
            int alt23=3;
    ...
    public final void mOctalEscape() throws RecognitionException {
        try {
            // Java.g:791:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
            int alt24=3;
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // Java.g:798:5: ( '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit )
            // Java.g:798:9: '\\\\' 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('\\'); 
    ...
    public final void mIdentifier() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:808:5: ( Letter ( Letter | JavaIDDigit )* )
            // Java.g:808:9: Letter ( Letter | JavaIDDigit )*
            {
            mLetter(); 


            // Java.g:808:16: ( Letter | JavaIDDigit )*
            loop25:
            do {
                int alt25=2;
    ...
    public final void mLetter() throws RecognitionException {
        try {
            // Java.g:820:5: ( '\\u0024' | '\\u0041' .. '\\u005a' | '\\u005f' | '\\u0061' .. '\\u007a' | '\\u00c0' .. '\\u00d6' | '\\u00d8' .. '\\u00f6' | '\\u00f8' .. '\\u00ff' | '\\u0100' .. '\\u1fff' | '\\u3040' .. '\\u318f' | '\\u3300' .. '\\u337f' | '\\u3400' .. '\\u3d2d' | '\\u4e00' .. '\\u9fff' | '\\uf900' .. '\\ufaff' )
            // Java.g:
            {
    ...
    public final void mJavaIDDigit() throws RecognitionException {
        try {
            // Java.g:834:5: ( '\\u0030' .. '\\u0039' | '\\u0660' .. '\\u0669' | '\\u06f0' .. '\\u06f9' | '\\u0966' .. '\\u096f' | '\\u09e6' .. '\\u09ef' | '\\u0a66' .. '\\u0a6f' | '\\u0ae6' .. '\\u0aef' | '\\u0b66' .. '\\u0b6f' | '\\u0be7' .. '\\u0bef' | '\\u0c66' .. '\\u0c6f' | '\\u0ce6' .. '\\u0cef' | '\\u0d66' .. '\\u0d6f' | '\\u0e50' .. '\\u0e59' | '\\u0ed0' .. '\\u0ed9' | '\\u1040' .. '\\u1049' )
            // Java.g:
            {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Java.g:854:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Java.g:854:9: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 



            // Java.g:854:14: ( options {greedy=false; } : . )*
            loop27:
            do {
                int alt27=2;
    ...
    class DFA18 extends DFA {
        ...
        public String getDescription() {
            return "760:1: FloatingPointLiteral : ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( Exponent )? ( FloatTypeSuffix )? | '.' ( '0' .. '9' )+ ( Exponent )? ( FloatTypeSuffix )? | ( '0' .. '9' )+ Exponent ( FloatTypeSuffix )? | ( '0' .. '9' )+ FloatTypeSuffix );";
        }
    }
